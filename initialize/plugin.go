...
import (
	...
	//"github.com/lhxlnsy/pap-go-server/plugin/email" // 本地插件仓库地址模式
	"github.com/gin-gonic/gin"
	"github.com/lhxlnsy/pap-go-server/plugin/example_plugin"
	"github.com/lhxlnsy/pap-go-server/utils/plugin"
)
